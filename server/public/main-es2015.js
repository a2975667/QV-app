...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<nav class=\"navbar navbar-light bg-light\">\r\n\t<div class=\"col-sm-2\">\r\n\t\t<br>\r\n\t</div>\r\n\t<div class=\"col-sm\">\r\n\t\t<div class=\"progress\">\r\n\t\t\t<div class=\"progress-bar progress-bar-striped progress-bar-animated\"\r\n\t\t\t\t[style.width.%]=\"(currentQuestion+1/numQuestion)*100\"></div>\r\n\t\t</div>\r\n\t</div>\r\n\t<div class=\"col-sm-2\" align=\"right\">\r\n\t\tPart {{currentFile}} Q{{currentQuestion+1}} / {{numFile}} Parts\r\n\t</div>\r\n</nav>\r\n\r\n\r\n<div class=\"container\">\r\n\t<br>\r\n\t<h1>{{questionTitle}}</h1>\r\n\r\n\t<p>\r\n\t\tFor the following question, you will use a <b>Binary Quadratic Voting</b> method to express your preferences.\r\n\t\t<br><br>\r\n\t\tYou will be given a budget of a certain number of <b> voice credits</b>. You will use the available credits to cast votes. If you are in favor of an option, you can cast one or more upvotes using the <b>+1  sign</b>. If you are against an option, you can cast one or more downvotes using the <b> -1 sign</b>. If you are neutral on an option, you can choose to cast <b> no vote </b>.\r\n\r\n\t\t<br><br>\r\n\t\t<b> Based on the intensity of your opinion, you can cast one or more upvotes or downvotes for each cause</b>. The stronger your opinion is, the more votes you can put on one option. At the same time, as the number of votes increases, the voice credits it costs increase quadratically, i.e. <b> X votes will cost X^2 (square of X) credits</b>. The cost of some common number of votes is specified in the table below:\r\n\t</p>\r\n\t\t<table style=\"width:100%\">\r\n\t\t\t<tbody>\r\n\t\t\t\t<tr>\r\n\t\t\t\t\t<th>Number of up or down votes</th>\r\n\t\t\t\t\t<td>1</td>\r\n\t\t\t\t\t<td>2</td>\r\n\t\t\t\t\t<td>3</td>\r\n\t\t\t\t\t<td>4</td>\r\n\t\t\t\t\t<td>5</td>\r\n\t\t\t\t\t<td>6</td>\r\n\t\t\t\t\t<td>7</td>\r\n\t\t\t\t\t<td>8</td>\r\n\t\t\t\t\t<td>9</td>\r\n\t\t\t\t\t<td>10</td>\r\n\t\t\t\t</tr>\r\n\t\t\t\t<tr>\r\n\t\t\t\t\t<th>Cost in number of voice credits</th>\r\n\t\t\t\t\t<td>1</td>\r\n\t\t\t\t\t<td>4</td>\r\n\t\t\t\t\t<td>9</td>\r\n\t\t\t\t\t<td>16</td>\r\n\t\t\t\t\t<td>25</td>\r\n\t\t\t\t\t<td>36</td>\r\n\t\t\t\t\t<td>49</td>\r\n\t\t\t\t\t<td>64</td>\r\n\t\t\t\t\t<td>81</td>\r\n\t\t\t\t\t<td>100</td>\r\n\t\t\t\t</tr>\r\n\t\t\t</tbody>\r\n\t\t</table>\r\n\t\t<p>\r\n\t\t\t<br>\r\n\t\t\t<b>You cannot exceed the budget of the given voice credits, but you do not have to use up all the available credits either. </b> You can see the total number of voice credits you have and the number of credits you have spent already in the “Summary” section below.\r\n\t\t</p>\r\n\t<hr>\r\n\r\n\t<div [innerHTML]=\"questionDes\"></div>\r\n\t<!--<p>{{questionDes}}</p>-->\r\n\r\n</div>\r\n<app-summary></app-summary>\r\n<app-option></app-option>\r\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".header {\n  position: fixed;\n  width: 100%;\n  top: 0;\n  background-color: aqua;\n  z-index: 1090;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
